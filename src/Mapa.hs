module Mapa where
    ...
    desenhaQuadrado (Ground _ cor) v1 v2 v3 v4 = desenhaQuadradoAux cor v1 v2 v3 v4
    desenhaQuadrado (ThornTrap _ cor) v1 v2 v3 v4 = desenhaQuadradoAux cor v1 v2 v3 v4
    desenhaQuadrado (ArrowTrap _ cor) v1 v2 v3 v4 = desenhaQuadradoAux cor v1 v2 v3 v4
    desenhaQuadrado (FireTrap _ cor) v1 v2 v3 v4 = desenhaQuadradoAux cor v1 v2 v3 v4
    desenhaQuadrado (Hole _ cor) v1 v2 v3 v4 = desenhaQuadradoAux cor v1 v2 v3 v4
    desenhaQuadrado (Indiana _ cor) v1 v2 v3 v4 = desenhaQuadradoAux cor v1 v2 v3 v4
